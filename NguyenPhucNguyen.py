...
""")
		...
		while True:
			try:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Nguyễn Phúc Nguyên"+Color.LB+" --> "+Color.LG+"Home"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option == '01' or option == '1':
					...
					print(f"{Color.LG} Nguyễn Phúc Nguyên: Done!")
				elif option == "":
					pass
				else:
...
""")
		...
		print("\n")
		while True:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Nguyễn Phúc Nguyên"+Color.LB+" --> "+Color.LG+"Proxy"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option == '01' or option == '1':
					...
					subprocess.run(['pkill -f NguyenPhucNguyen.py'], shell=True)
				elif option == 'stop' or option == 'STOP':
					subprocess.run(['pkill screen'], shell=True)
					print(f"{Color.LG} Nguyễn Phúc Nguyên: Done!")
				elif option == "":
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Nguyễn Phúc Nguyên"+Color.LB+" --> "+Color.LG+"Webtool"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				while True:
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Nguyễn Phúc Nguyên"+Color.LB+" --> "+Color.LG+"Layer4"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				try:
